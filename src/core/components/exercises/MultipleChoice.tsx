  ...
  return (
    <div className="w-full max-w-lg mx-auto">
      <div className="text-center mb-8">
        ...
        <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100 mt-2">{question}</h2>
      </div>
      ...
      <div className="space-y-3">
        {options.map((option, index) => (
          ...
          >
            <span className="w-8 h-8 rounded-lg bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-sm font-bold text-slate-500 dark:text-slate-400 shrink-0">
              {optionLetters[index]}
            </span>
